...
var svg_builder = {
	 ...
	 */
	draw_path: function (wooden_plate_thickness, size, rotate_case, draw_origin_x, draw_origin_y,angle=0,nbNotch=0) {
	 ...
	 */
	draw_side: function (wooden_plate_thickness, size,nbNotch=0) {
	 ...
	 */
	draw_inner_side: function (wooden_plate_thickness, size, nbNotch=0) {
